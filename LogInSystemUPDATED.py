...
class LogInSystem(object):
    ...
    def register(self):
        ...
        if userName!="" and passWord!="":
            ...
            if userName not in logIns: ##checks to see if username has already been taken
                ...
                print("Select a different username please")
        else:
            print("You have left one or both entries empty")
